...
import '../styles/fontpage.css'; // Use the existing `fontpage.css` in src/styles

function FrontPage({ onGoToHome }) { // Updated prop: onGoToHome instead of onGoToLibrary
    ...
    <div className="frontpage">
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <button className="explore-btn" onClick={onGoToHome}>Explore Books</button> {/* Now navigates to Home page */}
        </div>
      </section>
